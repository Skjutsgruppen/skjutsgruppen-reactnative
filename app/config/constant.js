...
export const NOTIFICATION_TYPE_CREATE_GROUP = 'create_group';
export const NOTIFICATION_TYPE_LEFT_GROUP = 'left_group';
export const NOTIFICATION_TYPE_JOINED_GROUP = 'joined_group';
export const NOTIFICATION_TYPE_COMMENT = 'comment';
export const NOTIFICATION_TYPE_SHARE = 'share';
